...
ribbons). It ships parsers for MCScanX, GENESPACE, and plain TSV input,
a real rice-sorghum dataset, interactive hover-and-tooltip plots via
**ggiraph**, and every colour argument accepts the 32 palettes of the
...
With no colours at all you get soft per-species pastels and
auto-generated ribbon hues:
