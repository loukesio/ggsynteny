...
and every colour argument accepts the 32 palettes of the [ltc
...
identity. By default that is a light-to-dark blue ramp; name an ordered
palette (`heatmap0`–`heatmap3`) to restyle it:
...
| [`plot_microsynteny()`](https://loukesio.github.io/ggsynteny/reference/plot_microsynteny.md) | Micro-synteny: gene arrows + homology ribbons (`palette`, `gene_fill`, `ribbon_fill = "identity"`) |
